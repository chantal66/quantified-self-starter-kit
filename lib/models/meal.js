...
class Meal {
  ...
  static sortByCalories(mealName) {
    ...
    .then((mealFoods) => {
      ...
      const sortedFoods = Meal.quickSort(foodsArray);
      // sortedFoods is an array of foods, sorted by calories
      // TODO remove the meal's foods from the DOM and replace them with these foods
    })
  }
